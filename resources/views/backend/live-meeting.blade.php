				...
				<div class="card">
					...
					<div class="card-body tabs-area p-0">
						<ul class="tabs-nav">
							...
							<li><a class="active" id="tabId-3" href="{{ route('backend.live-meeting') }}"><i class="fa fa-exchange"></i>{{ __('Live Meeting') }}</a></li>
...
<!--js -->
<script src="{{asset('public/pages/live_meeting.js')}}"></script>
